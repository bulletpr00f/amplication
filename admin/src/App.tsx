...
import { PullRequestsIndex } from "./pullRequests/PullRequestsIndex";
      ...
      <MainLayout.Content>
        ...
        <Page>
          <Switch>
            ...
            <PrivateRoute path="/pull-requests" component={PullRequestsIndex} />
          </Switch>
        </Page>
      </MainLayout.Content>
    </>
